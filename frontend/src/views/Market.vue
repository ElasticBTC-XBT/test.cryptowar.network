            ...
            <div class="row button-row">
              ...
              <div class="mb-2">
                <b-button
                  ...
                  :class="isBtnSell===true&&activeType==='weapon'?'gtag-link-others search-btn selected':'gtag-link-others search-btn'"
                  tagname="search_own_weapons">Selling Weapons</b-button>
              </div>
