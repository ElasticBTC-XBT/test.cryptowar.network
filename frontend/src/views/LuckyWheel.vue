    ...
    <div>
        <div class="wheel-wrapper">
            <div class="wheel" ref="wheel">
                <div class="wheel-border-arrow" v-for="(reward, index) in rewards" :key="index">
                    <i class="fas fa-caret-up"></i>
                </div>
                <div class="wheel__inner">
                    <div class="wheel__sec" v-for="(reward, index) in rewards" :key="index">
        ...
        <b-modal
            class="centered-modal text-center" ref="rewardModal"
            ok-only ok-title="Close" ok-variant="secondary btn-pink-bg" @ok="resetWheel"
            title="Congratulation!" title-class="text-white">
            <div class="reward-modal-body">
                <span class="reward-text">
                    <img src="../assets/v2/congrate-emoji.svg" class="congrate-emoji"> You recived
                </span>
                <div class="reward-container">
                    <div :class="'reward-img-modal reward-img-' + rewardIndex"></div>
                    <div class="reward-info">
                        <span class="reward-modal-quantity">{{ rewards[rewardIndex - 1].quantity }} </span>
