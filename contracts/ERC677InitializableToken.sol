...
contract ERC677 is ERC20BurnableUpgradeable, OwnableUpgradeable {
    event Transfer(
...
contract ERC677InitializableToken is ERC677 {
    ...
    function initialize(
        ...
        ERC20Upgradeable.__ERC20_init_unchained("xBlade", "xBlade");
